...
const PostItemActions = ({ repostHandler, setShowComments, showRepostButton, commentsLength, postId, isSidebarItem }: { repostHandler: Function, setShowComments?: Function, showRepostButton: boolean, commentsLength: number, postId: string, isSidebarItem?: boolean }) => {
