      ...
      <div className="w-2/4 pt-5">
         <div className="bg-color-primary-bg rounded-2xl px-3 py-6">
            ...
            <div className="flex gap-3">
               <div className="w-20 h-20 flex-shrink-0 relative overflow-hidden rounded-full">
                  {!photoPreview && <img className="w-full h-full rounded-full overflow-hidden" src="/user-logo.png" alt="user logo" />}
                  {photoPreview && <img className="w-full h-full rounded-full overflow-hidden" src={photoPreview} alt="user logo" />}
                  <label className={`w-full h-full absolute -bottom-12 left-0 flex justify-center items-start cursor-pointer rounded-full`}>
                     <svg className="relative z-20 mt-2" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M2.5 13.3333L6.66667 9.16667C7.44 8.4225 8.39333 8.4225 9.16667 9.16667L12.5 12.5" stroke="#D5D5D5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M11.6667 11.6667L12.5001 10.8333C13.0442 10.3092 13.6776 10.1542 14.2751 10.3675M15.8334 13.3333V18.3333M15.8334 18.3333L18.3334 15.8333M15.8334 18.3333L13.3334 15.8333" stroke="#D5D5D5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                     </svg>
            ...
            <div className="mt-5">
               ...
               <p className="text-xs text-color-primary-text pt-2">
         ...
         {Object.keys(modalsObj).map(item => (
            <Modal key={item} setOpen={modalsObj[item].setModal} open={modalsObj[item].modal}>
               <UserEditForm type={item} onSubmithandler={(e: React.FormEvent<HTMLFormElement>, text: string) => {
                  e.preventDefault()
                  console.log(text);
               }} />
            </Modal>
